            ...
            <div class="card card-outline card-success">
                <div class="card-header p-2">
                    <ul class="nav nav-pills" id="transactionTabs">
                        <li class="nav-item"><a class="nav-link active" href="#expense" data-toggle="tab"
                                data-type="expense"><i class="fas fa-arrow-down text-danger mr-1"></i> Pengeluaran</a></li>
                        <li class="nav-item"><a class="nav-link" href="#income" data-toggle="tab" data-type="income"><i
                                    class="fas fa-arrow-up text-success mr-1"></i> Pemasukan</a></li>
                        <li class="nav-item"><a class="nav-link" href="#transfer" data-toggle="tab" data-type="transfer"><i
                                    class="fas fa-exchange-alt text-info mr-1"></i> Transfer Kas</a></li>
                    </ul>
                </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" name="description" class="form-control"
                                    placeholder="Contoh: Beli Bensin, Gaji Bulanan, dll." required>
                            </div>
                        </div>
                            ...
                            <div class="col-md-5">
                                ...
                                <select name="account_a" id="account_a" class="form-control select2" required>
                                    ...
                                    @foreach ($accounts as $account)
                                        <option value="{{ $account->id }}" data-category="{{ $account->category }}"
                            ...
                            <div class="col-md-6 mx-auto">
                                ...
                                <div class="input-group input-group-lg mb-3">
                                    ...
                                    <input type="text" id="amount_display"
                                        class="form-control text-right font-weight-bold numeric-input" required
                                        placeholder="0">
...
@section('js')
    ...
    <script>
        ...
        function filterOptions(selectId, allowedCategories) {
            ...
            select.find('option').each(function() {
                ...
                if (allowedCategories.includes(cat)) {
                    ...
                    if (opt.val() === currentValue) select.val(null);
                }
            });
            select.select2({
                theme: 'bootstrap4',
        ...
        function updateFormUI(type) {
            ...
            // Reset Selections
            $('#account_a').val(null).trigger('change');
            $('#account_b').val(null).trigger('change');
